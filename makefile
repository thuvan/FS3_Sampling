...
uniform_sampling.out:matrix_base.o StringTokenizer.o random.o uniform_freq.cpp database.h pattern.h adj_matrix.h pattern_factory.h subgraph_iso.h graph_iso_check.h uniform_freq_random_walk.h
